...
namespace GameDevTV.Saving
{
    ...
    public class SaveableEntity : MonoBehaviour
    {
        ...
        // CACHED STATE
        static Dictionary<string, SaveableEntity> globalLookup = new Dictionary<string, SaveableEntity>();  // this dictionary stays for the lifetime of the application
        ...
        private void Update()
        {
            ...
            // if it is a prefab, return
            if (string.IsNullOrEmpty(gameObject.scene.path)) return;

            // find serialization of this MonoBehaviour
            ...
            if (string.IsNullOrEmpty(property.stringValue) || !IsUnique(property.stringValue))
            {
                ...
                serializedObject.ApplyModifiedProperties();  // notify Unity that we have made changes to our serializedObject
            }
